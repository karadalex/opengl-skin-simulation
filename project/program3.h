...
GLuint projectionMatrixLocation, viewMatrixLocation, modelMatrixLocation, scalpelMatrixLocation;
...
// scalpel transformations
GLuint scalpelTransformationsLocation;
vector<mat4> scalpelTransformations;
...
void createContext() {
    ...
    scalpelMatrixLocation = glGetUniformLocation(shaderProgram, "SM");
    ...
    scalpelTransformationsLocation = glGetUniformLocation(shaderProgram, "scalpelTransformations");

    glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);

    skin = new Skin("models/skin3.obj");
	scalpel = new Drawable("models/scalpel.obj");
...
void mainLoop() {
    ...
    do {
		...
		glUniform1i(objectVAOLocation, scalpel->VAO);
		scalpel->bind();
		scalpel->draw();

        mat4 projectionMatrix = camera->projectionMatrix;
        mat4 viewMatrix = camera->viewMatrix;
        glm::mat4 modelMatrix = glm::translate(mat4(), vec3(0.0, 0.0, -10.0));
        ...
        glUniformMatrix4fv(scalpelMatrixLocation, 1, GL_FALSE, &scalpelMatrix[0][0]);
